<?php 
  ...
  { 
    $html.='<tr>
            ...
            <td align="center"><img src="'.$row["image"].'" height="50" width="50"></td>
            <td align="center">'.$row["type"].'</td>
            <td align="center">'.$row["city"].'</td>
            <td align="center">'.$row["religion"].'</td>
            <td align="center">'.$row["email"].'</td>
            <td style="text-align:center">
            <a class="btn btn-primary btn-xs fa fa-pencil" 
            href="index.php?pid=19 & id='.$row["id"].'"></a>
            <a class="btn btn-danger btn-xs fa fa-trash-o" 
            href="index.php?pid=20 & id='.$row["id"].'"></a> 
            </td>
          </tr>';
        $counter++;
  }
 ...
 <!-- **********************************************************************************************************************************************************
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>&nbsp;&nbsp;&nbsp;&nbsp;Manage Criminals</h3>
        <div class="row mb">
          <!-- page start-->
          <div class="content-panel">
            <div class="adv-table">
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    <th style="text-align:center;" class="hidden-phone">Name</th>
                    ...
                    <th style="text-align:center;" class="hidden-phone">Religion</th>
