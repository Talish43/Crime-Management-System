<?php 
  $counter=1;
  $html="";
  $query       = "SELECT * FROM tbl_registered_users ";
  ...
  while($row = mysqli_fetch_array($queryResult))
  {
    $html.='<tr>
          ...
          href="index.php?pid=35 & id='.$row["id"].'"></a>
          <a class="btn btn-danger btn-xs fa fa-trash-o" 
          href="index.php?pid=36 & id='.$row["id"].'"></a>
          </td>
        </tr>';
      $counter++;
  }
 ...
 <!-- **********************************************************************************************************************************************************
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>&nbsp;&nbsp;&nbsp;&nbsp;Manage Registered Users</h3>
        <div class="row mb">
          <!-- page start-->
